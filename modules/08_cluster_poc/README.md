...
- <a name="requirement_mongodbatlas"></a> [mongodbatlas](#requirement_mongodbatlas) (~> 1.26)

## Providers

The following providers are used by this module:

- <a name="provider_mongodbatlas"></a> [mongodbatlas](#provider_mongodbatlas) (1.39.0)
...
### <a name="input_accept_data_risks_and_force_replica_set_reconfig"></a> [accept_data_risks_and_force_replica_set_reconfig](#input_accept_data_risks_and_force_replica_set_reconfig)
...
### <a name="input_advanced_configuration"></a> [advanced_configuration](#input_advanced_configuration)
...
### <a name="input_auto_scaling"></a> [auto_scaling](#input_auto_scaling)
...
### <a name="input_auto_scaling_analytics"></a> [auto_scaling_analytics](#input_auto_scaling_analytics)
...
### <a name="input_bi_connector_config"></a> [bi_connector_config](#input_bi_connector_config)
...
### <a name="input_cluster_type"></a> [cluster_type](#input_cluster_type)
...
### <a name="input_config_server_management_mode"></a> [config_server_management_mode](#input_config_server_management_mode)
...
### <a name="input_delete_on_create_timeout"></a> [delete_on_create_timeout](#input_delete_on_create_timeout)
...
### <a name="input_disk_size_gb"></a> [disk_size_gb](#input_disk_size_gb)
...
### <a name="input_encryption_at_rest_provider"></a> [encryption_at_rest_provider](#input_encryption_at_rest_provider)
...
### <a name="input_global_cluster_self_managed_sharding"></a> [global_cluster_self_managed_sharding](#input_global_cluster_self_managed_sharding)
...
### <a name="input_instance_size"></a> [instance_size](#input_instance_size)
...
### <a name="input_instance_size_analytics"></a> [instance_size_analytics](#input_instance_size_analytics)
...
### <a name="input_mongo_db_major_version"></a> [mongo_db_major_version](#input_mongo_db_major_version)
...
### <a name="input_paused"></a> [paused](#input_paused)
...
### <a name="input_pinned_fcv"></a> [pinned_fcv](#input_pinned_fcv)
...
### <a name="input_pit_enabled"></a> [pit_enabled](#input_pit_enabled)
...
### <a name="input_provider_name"></a> [provider_name](#input_provider_name)
...
### <a name="input_redact_client_log_data"></a> [redact_client_log_data](#input_redact_client_log_data)
...
### <a name="input_replica_set_scaling_strategy"></a> [replica_set_scaling_strategy](#input_replica_set_scaling_strategy)
...
### <a name="input_replication_specs"></a> [replication_specs](#input_replication_specs)
...
### <a name="input_retain_backups_enabled"></a> [retain_backups_enabled](#input_retain_backups_enabled)
...
### <a name="input_root_cert_type"></a> [root_cert_type](#input_root_cert_type)
...
### <a name="input_termination_protection_enabled"></a> [termination_protection_enabled](#input_termination_protection_enabled)
...
### <a name="input_version_release_system"></a> [version_release_system](#input_version_release_system)
...
### <a name="output_config_server_type"></a> [config_server_type](#output_config_server_type)

Description: Describes a sharded cluster's config server type.

### <a name="output_connection_strings"></a> [connection_strings](#output_connection_strings)

Description: Collection of Uniform Resource Locators that point to the MongoDB database.

### <a name="output_create_date"></a> [create_date](#output_create_date)
...
### <a name="output_mongo_db_version"></a> [mongo_db_version](#output_mongo_db_version)

Description: Version of MongoDB that the cluster runs.

### <a name="output_state_name"></a> [state_name](#output_state_name)
