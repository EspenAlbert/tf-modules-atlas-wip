...
resource "mongodbatlas_alert_configuration" "this" {
  enabled    = var.mongodbatlas_alert_configuration.enabled
  event_type = var.mongodbatlas_alert_configuration.event_type
  dynamic "matcher" {
    for_each = var.mongodbatlas_alert_configuration.matcher == null ? [] : var.mongodbatlas_alert_configuration.matcher
    content {
  ...
  dynamic "metric_threshold_config" {
    for_each = var.mongodbatlas_alert_configuration.metric_threshold_config == null ? [] : var.mongodbatlas_alert_configuration.metric_threshold_config
    content {
  ...
  dynamic "notification" {
    for_each = var.mongodbatlas_alert_configuration.notification == null ? [] : var.mongodbatlas_alert_configuration.notification
    content {
  ...
  project_id = var.mongodbatlas_alert_configuration.project_id
  dynamic "threshold_config" {
    for_each = var.mongodbatlas_alert_configuration.threshold_config == null ? [] : var.mongodbatlas_alert_configuration.threshold_config
    content {
